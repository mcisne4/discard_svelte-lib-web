...
<script lang="ts">
  ...
  let values: {
    ...
    rotate?: string;
    transition?: string;
    transitionSun?: string;
    transitionRays?: string;
  } = {};
...
<div>
  ...
  <!-- ___ --svg-transition-sun ___ -->
  <InputText
    description="--svg-transition-sun"
    defaultValue="none"
    on:valid={(e) => (values.transitionSun = e.detail)}
  />

  <!-- ___ --svg-transition-rays ___ -->
  <InputText
    description="--svg-transition-rays"
    defaultValue="none"
    on:valid={(e) => (values.transitionRays = e.detail)}
  />
</div>
